...
r3 = Review.create(name: "Name LastName3", review: "oof")
r4 = Review.create(name: "Name LastName4", review: "Fresh!")
r5 = Review.create(name: "Name LastName5", review: "Tasty!")
r6 = Review.create(name: "Name LastName6", review: "u w0t m8")
r7 = Review.create(name: "Name LastName7", review: "naisu")
r8 = Review.create(name: "Name LastName8", review: "aight")
r9 = Review.create(name: "Name LastName9", review: "goot")
r10 = Review.create(name: "Name LastName10", review: "good")
r11 = Review.create(name: "Name LastName11", review: "average")
r12 = Review.create(name: "Name LastName12", review: "i can grow better")
r13 = Review.create(name: "Name LastName13", review: "okay")
r14 = Review.create(name: "Name LastName14", review: "trolololol")
r15 = Review.create(name: "Name LastName15", review: "don't buy")
r16 = Review.create(name: "Name LastName16", review: "yikes")
